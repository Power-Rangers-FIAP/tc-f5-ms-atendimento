...
public class LoginServiceImpl implements LoginService {
    ...
    public Token login(String email, String senha) {
       ...
       if (usuarios != null) {
           usuario = Arrays.stream(usuarios)
                   .filter(u -> email.equals(u.email()))
                   .findFirst()
                   .orElseThrow(RuntimeException::new);
           if (senha.equals(usuario.senha())) {
               return new Token("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWRQYWNpZW50ZSI6ImNmMjkwYjljLWQ5NTgtNDk1Ni05ODhkLWM4YjNhZjk1NzdjZCIsImlhdCI6MTUxNjIzOTAyMn0.h22ECTmRscoooy-A91SOK1G9G_t6aGWSxTsDMYPms7c");
           }
       }

       throw new RuntimeException(); //TODO: Retornar erro de login inválido
    }
}
